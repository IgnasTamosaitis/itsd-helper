...
> **Current release: v1.5.3**<br>
> [Download the Windows installer](https://github.com/IgnasTamosaitis/Jira-onboarding-helper/releases/download/v1.5.3/Jira-Reminders-1.5.3.msi)
> · [View the release](https://github.com/IgnasTamosaitis/Jira-onboarding-helper/releases/tag/v1.5.3)
...
1. Download [**`Jira-Reminders-1.5.3.msi`**](https://github.com/IgnasTamosaitis/Jira-onboarding-helper/releases/download/v1.5.3/Jira-Reminders-1.5.3.msi)
